...
<body>
    ...
    @if (request('bulan') && $laporan->isNotEmpty())
        <p>
            Periode :
            {{ $laporan->first()->periodeGaji->bulan }}
            {{ $laporan->first()->periodeGaji->tahun }}
        </p>
    @endif
    <div class="info">
        <div>
            ...
            <tfoot>
                <tr>
                    <td colspan="5" align="right">
                        <b>Total Seluruh Gaji Karyawan</b>
                    </td>
                    <td align="right">
                        <b>Rp {{ number_format($laporan->sum('total_gaji'), 0, ',', '.') }}</b>
                    </td>
                </tr>
            </tfoot>
        </table>
