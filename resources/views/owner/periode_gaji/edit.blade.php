...
@section('content')
    <div class="rounded-xl bg-white p-6 shadow-sm">
        ...
        <div class="mb-6">
            <h1 class="heading text-2xl font-semibold text-gray-800">Edit Periode Gaji</h1>
            <p class="body-text text-sm text-gray-500">Ubah data periode gaji.</p>
        </div>
        ...
        <form action="{{ route('owner.periode-gaji.update', $periode->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    <label class="mb-2 block text-sm font-medium text-gray-700">Gaji per Order</label>
