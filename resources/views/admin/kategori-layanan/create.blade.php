    ...
    <form action="{{ route('admin.kategori-layanan.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="nama_kategori" class="form-input pl-10" placeholder="Masukkan nama kategori" value="{{ old('nama_kategori') }}">
            </div>
            @error('nama_kategori')
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('admin.kategori-layanan.index') }}" class="rounded-lg bg-gray-300 px-4 py-2 hover:bg-gray-400">Batal</a>
