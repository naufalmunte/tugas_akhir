    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="border-b border-gray-100 px-6 py-4 flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Tambah Layanan</h1>
                    <p class="text-sm text-gray-500 mt-1">Masukkan detail layanan baru untuk pelanggan.</p>
                </div>
                                ...
                                <select name="kategori_layanan_id"
                                    ...
                                    @foreach ($kategori as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('kategori_layanan_id') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga"
                                        ...
                                        value="{{ old('harga') }}" placeholder="Contoh: 50000">
                                </div>
                                @error('harga')
                                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="estimasi_menit"
                                        ...
                                        value="{{ old('estimasi_menit') }}" placeholder="Contoh: 45">
                                </div>
